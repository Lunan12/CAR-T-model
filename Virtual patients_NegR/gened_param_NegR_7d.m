...
genparam_set_file = '../NegR_Bch_13.csv';
fi = fopen(genparam_set_file);
    C = textscan(fi, '%s %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f %f','headerlines',1,'delimiter',',');
fclose(fi);
...
for kgen = 1:length(C{1})
        ...
        %     Param=[0.070779259	1.686986892	0.109101224	3.03E-05	2808.586835	26.14056824	7932.097398	813.2196461	2118.538966	0.395195924];
            ...
            [t,f]=ode45(@eqs_NegR,0:7,f0,[], rBp, rTA0, lTA0, lTN, nMB, eBp, ka, KBp, KBpr, KBpTN, rBn, km, kb, KBn);
            ...
            dataset_file = dataset_dir + dataset_filename;
                ...
                for kt = 1:length(t)
                    fprintf(fi, '%s, %f, %f, 1, %f\n', C{1}{kgen}, t(kt), f(kt,2), nB0+nN0);
                end
                fprintf(fi, '%s, 0, %f, 2, %f', C{1}{kgen}, nB0+nN0, nB0+nN0);
            fclose(fi);
